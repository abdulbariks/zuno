...
const Navbar = () => {
  return (
    <nav className="fixed top-2 left-1/2 -translate-x-1/2 w-11/12 md:w-8/12  backdrop-blur-sm inset-shadow-2xs shadow px-6 py-3 rounded-md flex items-center justify-between">
